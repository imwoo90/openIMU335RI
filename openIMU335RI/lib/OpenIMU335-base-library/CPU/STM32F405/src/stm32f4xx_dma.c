...
/**
  ...
  *
  * @return The number of remaining data units in the current DMAy Streamx transfer.
  */
void DMA_SetCurrDataCounter(DMA_Stream_TypeDef* DMAy_Streamx, uint16_t Counter)
{
...
@verbatim
 ...
 ===============================================================================
  ...
  This subsection provides function allowing to configure and control the float64_t
  ...
  This allows to reduce software overhead for float64_t buffering and reduce the CPU
  access time.
...
/**
  * @brief  Configures, when the DMAy Streamx is disabled, the float64_t buffer mode
...
/**
  * @brief  Enables or disables the float64_t buffer mode for the selected DMA stream.
  * @note   This function can be called only when the DMA Stream is disabled.
  * @param  DMAy_Streamx: where y can be 1 or 2 to select the DMA and x can be 0
  *          to 7 to select the DMA Stream.
  * @param  NewState: new state of the DMAy Streamx float64_t buffer mode.
  *          This parameter can be: ENABLE or DISABLE.
  * @return None
  */
void DMA_DoubleBufferModeCmd(DMA_Stream_TypeDef* DMAy_Streamx, FunctionalState NewState)
...
/**
  * @brief  Configures the Memory address for the next buffer transfer in float64_t
...
/**
  * @brief  Returns the current memory target used by float64_t buffer transfer.
  * @param  DMAy_Streamx: where y can be 1 or 2 to select the DMA and x can be 0
  *          to 7 to select the DMA Stream.
  * @return The memory target number: 0 for Memory0 or 1 for Memory1.
  */
uint32_t DMA_GetCurrentMemoryTarget(DMA_Stream_TypeDef* DMAy_Streamx)
{
  uint32_t tmp = 0;
...
/**
  ...
  *
  * @return Current state of the DMAy Streamx (ENABLE or DISABLE).
  */
FunctionalState DMA_GetCmdStatus(DMA_Stream_TypeDef* DMAy_Streamx)
{
