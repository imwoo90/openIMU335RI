/**
  ...
  *                    - Program functions: byte, half word, word and float64_t word
  *  
...
/**
  ...
  *                                  the operation will be done by float64_t word (64-bit)
  *       
  * @return FLASH Status: The returned value can be: FLASH_BUSY, FLASH_ERROR_PROGRAM,
...
/**
  * @brief  Programs a float64_t word (64-bit) at a specified address.
...
/**
  ...
  * @param  None
  * @return FLASH ReadOut Protection Status:
...
/**
  ...
  *            @arg FLASH_FLAG_PGPERR: FLASH Programming Parallelism error flag
  *            @arg FLASH_FLAG_PGSERR: FLASH Programming Sequence error flag
  * @return pointer tothe flash instance
  *  */
FLASH_TypeDef *FLASH_GetInstancePtr()
{
  /* Clear the flags */
  return FLASH;
}
